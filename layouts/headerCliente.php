<header>
    ...
    <div class="container__logo__menu">
        <img src="assets/img/logoSigra.svg" class="img-fluid" alt="logoSigra">
    </div>

    <div class="container__nav__menu">
        ...
        <div class="container__general" id="container-general">
            <div class="container__closed">
                <i class="fa-solid fa-circle-xmark" id="cerrar"></i>
            </div>
            <nav class="container__list__menu">
                <ul class="list__menu">
                    <li class="list__link__menu"><a href="menuCliente.php"><i class="fa-solid fa-house-chimney"></i></a></li>
                </ul>
            </nav>
            <div class="container__button__menu">
                <button class="button__One__menu" id="cerrarSesionBtn"><i class="fa-solid fa-circle-xmark"></i>CERRAR SESIÓN</button>
            </div>
        </div>
    </div>
</header>
