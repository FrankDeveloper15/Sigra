            ...
            <table class="table table-servicios">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>03 / 02 / 2022</td>
                        <td>
                            <button class="btn btn-primary clr-cre" id="edit-servicios" data-bs-target="#modalEditarServicios" data-bs-toggle="modal" style="border-radius: 10px 0 0 10px;"><i class="fa-solid fa-pen"></i></button><button class="btn btn-primary clr-so" id="delete-servicios" data-bs-target="#modalEliminarServicios" data-bs-toggle="modal" style="border-radius: 0 10px 10px 0;"><i class="fa-solid fa-circle-xmark"></i></button>
                                                ...
                                                <form id="form-editar-servicios" action="">
                                                    ...
                                                    <div class="row align-items-center mb-3">
                                                        <div class="row align-items-center mb-3">
                                                            ...
                                                            <div class="col-md-5">
                                                                <div class="row">
                                                                    <label for="correoProveedor" class="col-auto col-form-label">Correo de Proveedor:</label>
                                                                    <div class="col">
